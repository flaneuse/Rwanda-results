...
mcu.append("text")
    .attr("class", "top-label")
    .attr("x", -margins.mcu.left + 10)
    .attr("y", 0)
    .attr("dy", -margins.mcu.top/2)
    .text("percent of women 15-49 married or in a union using modern contraception");
