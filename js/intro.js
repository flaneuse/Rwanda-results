          ...
          fullG.select("#afr1").selectAll(".g-pop-explain")
            ...
            fullG.append("div")
              ...
              fullG.append("div")
                ...
                .attr("class", "intro-full")
                .style("max-width", "inherit")
                .html("<div id='g-Rwanda_LakeVic_final-box' class='ai2html'>	<!-- Generated by ai2html v0.61 - 2017-02-15 - 17:52 -->	<!-- ai file: Rwanda_LakeVic_final -->	<!-- Artboard: lakevic -->	<div id='g-Rwanda_LakeVic_final-lakevic' class='g-artboard g-artboard-v3 ' data-min-width='807'>		<div id='g-Rwanda_LakeVic_final-lakevic-graphic'>			<img id='g-ai0-0'				class='g-aiImg'				src='/img/intro/afr3.png'				/>			<div id='g-ai0-1' class='g-ne_10m_lakes g-aiAbs' style='top:45.6575%;left:47.1072%;width:12.5974%;margin-left:-6.2987%;'>				<p class='g-aiPstyle0'>Lake Victoria</p>			</div>			<div id='g-ai0-2' class='g-_Layer_ g-aiAbs' style='top:67.9553%;left:1.7131%;'>				<p class='g-aiPstyle1'>Rwanda is the densest nation in Africa</p>			</div>			<div id='g-ai0-3' class='g-scrolly-text g-aiAbs' style='top:72.5564%;left:1.713%;width:70.9172%;'>				<p class='g-aiPstyle2'>Though individual cities are more concentrated, almost all of Rwanda &mdash; even outside the urban areas &mdash; has high population density. Indeed, Rwanda has the highest population per square kilometer3 (471 people / km2) in all of Africa.</p>			</div>		</div>	</div>	<!-- End ai2html - 2017-02-15 - 17:52 --></div>")
                .style("opacity", 0);
